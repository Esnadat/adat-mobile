...
const styles = StyleSheet.create({
  ...
  typePermission: { backgroundColor: colors.surfaceSubtle, borderWidth: 1, borderColor: "rgba(0, 43, 102, 0.15)" },
  ...
  typeMissedPunch: { backgroundColor: colors.surfaceSubtle, borderWidth: 1, borderColor: "rgba(0, 43, 102, 0.2)" },
